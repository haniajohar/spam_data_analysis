...
This project contains a Jupyter notebook for exploring and analyzing the `WELFake_Dataset.csv` spam dataset. The notebook loads the data, inspects its structure, and supports further experimentation with text analysis and spam classification workflows.
